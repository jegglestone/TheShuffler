...
namespace ShufflerLibrary.Tests.Unit
{
    ...
    [TestFixture]
    public class TimerUnitStrategyTestsk
    {
        [Test]
        ...
        {
            // Real GDP PASTrose by DIG100 TMper month 
            ...
            var sentence = new Sentence()
            {
                Texts = new List<Text>()
                {
                    ...
                    new Text() {pe_text = " rose ", pe_tag = "NULL", pe_tag_revised = "PAST", pe_order = 1663990},
                    new Text() {pe_text = " by ", pe_tag = "BK", pe_tag_revised = "NULL", pe_order = 1663990},
                    new Text() {pe_text = " 100 ", pe_tag = "DIG", pe_tag_revised = "NULL", pe_order = 1664010},
                    new Text() {pe_text = " something ", pe_tag = null, pe_tag_revised = null, pe_order = 1664010},
            ...
            // per month Real  GPD  rose  by  100
            Assert.That(returnedSentence.Texts[0].pe_text, Is.EqualTo(" per month ")); //TM
            Assert.That(returnedSentence.Texts[1].pe_text, Is.EqualTo(" Real "));  //ADJ
            Assert.That(returnedSentence.Texts[2].pe_text, Is.EqualTo(" GDP "));
            ...
            Assert.That(returnedSentence.Texts[6].pe_text, Is.EqualTo(" something "));
        ...
        [Test]
        public void WhenNoAdverBeforeTimer_MoveBeforeVbVbaPast()
        {
